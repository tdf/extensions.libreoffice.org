...
#
#  $ bin/test -s tdf.migration -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src tdf.migration.testing.TDF_MIGRATION_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/tdf/migration/tests/robot/test_example.robot
#
